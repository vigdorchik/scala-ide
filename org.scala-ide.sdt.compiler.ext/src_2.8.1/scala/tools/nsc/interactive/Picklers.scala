...
import _root_.scala.tools.nsc.io.{AbstractFile, PlainFile}

import _root_.scala.tools.nsc.util.{Position, RangePosition, NoPosition, OffsetPosition, TransparentPosition}
import scala.tools.nsc.interactive.io.{Pickler, CondPickler}
import scala.tools.nsc.interactive.io.Pickler._
import _root_.scala.collection.mutable
import mutable.ListBuffer

import scala.tools.nsc.interactive.util.{InterruptReq, EmptyAction}
